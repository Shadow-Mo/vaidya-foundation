  ...
  return (
    <div className="relative bg-white dark:bg-gray-900 overflow-hidden">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white sm:text-5xl md:text-6xl">
                <span className="block xl:inline">Help Those</span>{" "}
                <span className="block text-emerald-600 xl:inline">
                  Who Need It Most
                </span>
              </h1>
              <p className="mt-3 text-base text-gray-500 dark:text-gray-400 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                Join the Vaidya Foundation in making a real difference. Your
                donations directly support critical medical care, education, and
                emergency relief for underserved communities.
              </p>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <div className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full bg-gradient-to-r from-emerald-400 to-blue-500 flex items-center justify-center">
          <p className="text-white text-lg font-medium italic px-4 text-center">
